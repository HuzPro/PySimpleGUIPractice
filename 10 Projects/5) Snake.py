...
menuLayout = [
    ...
    [sg.pin(sg.Slider(k="-SPEED SLIDER-",range=(1,100), orientation="h", enable_events=True, visible=False, size=(128,16)))],
...
while True:
    ...
    if event2 == "-OPTIONS BUTTON-":
        ...
        window2["-SPEED SLIDER-"].update(default_value=snakeSpeed)
            ...
            if timeSinceStart >= snakeSpeed:
                ...
                for index, part in enumerate(snakeBody):
                    ...
                    if index == len(snakeBody)-1:                               #Tail
                        ...
                        print("prevTail:"+str(delBody[index])+"\nsnakeBody:"+str(snakeBody))
